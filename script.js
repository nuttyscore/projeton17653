...
let tempoPorQuiz = 90; // tempo total por matéria em segundos (exemplo: 1m30s)
let tempoRestante = tempoPorQuiz;
...
function iniciarTemporizador() {
  ...
  tempoRestante = tempoPorQuiz;
  temporizadorInterval = setInterval(() => {
    tempoRestante--;
    // Opcional: mostrar tempo restante no score
    score.innerText = `Tempo restante: ${tempoRestante}s`;
...
function reiniciarQuiz() {
  // Reseta tudo e começa do início sem mensagem
  indice = 0;
  pontos = 0;
  score.innerText = "";
  carregarPergunta();
